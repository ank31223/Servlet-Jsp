...
public class GetAllClientsServlet extends HttpServlet {
	...
	private void viewEmployeesUnderClient(HttpServletRequest req, HttpServletResponse res)
	...
	private void removeClientEmployee(HttpServletRequest req, HttpServletResponse res)
			throws ServletException, IOException {
		String clientName = req.getParameter("clientName");
	...
	private void addEmployeeToClient(HttpServletRequest req, HttpServletResponse res)
			throws ServletException, IOException {
